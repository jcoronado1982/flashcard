...
function Controls({ onPrev, onNext, onMarkLearned, onReset, currentIndex, totalCards, deckNames, onDeckChange, currentDeckName }) {
    ...
    return (
        <div id="controls-wrapper">
            ...
            <div className="deck-selector-container">
                <label htmlFor="deck-select" className="deck-selector-label">
                    Palabra: 
                </label>
                <select 
                    id="deck-select" 
            ...
            <div id="controls">
                ...
                <button id="resetButton" className="action-btn" onClick={onReset} title={`Resetear la tarjeta: ${currentDeckName}`}>
